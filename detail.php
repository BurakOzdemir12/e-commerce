 ...
 if(isset($_POST['add_to_cart'])){
    ...
    if($product_stock >= $product_quantity){
       ...
       $upload = mysqli_query($connect, $update_data);
        ...
        $stockerror = '<p style="color: #ff0000; font-weight: bold;">Belirtilen miktarda ürün bulunmamaktadır. Stoktaki ürün sayısı: ';

        $select = mysqli_query($connect, "SELECT * FROM products WHERE id='$id' ");
        while($row = mysqli_fetch_assoc($select)){
          $product_stock = $row['stock'];
          $stockerror .= $product_stock;
        }
...
<body>
        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    <a class="breadcrumb-item text-dark" href="index.html">Ana Sayfa</a>
    ...
    <?php $select = mysqli_query($connect, "SELECT * FROM products WHERE id='$id' "); ?>
            ...
            // Veritabanından ürün ayrıntılarını al
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="admin/uploaded_img/<?php echo $row['image']; ?> " height="100"  alt="">
                        </div>
                        <!-- Ekstra ürün fotoğrafı için gerekli satır
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <p class="mb-4">Volup erat ipsum diam elitr rebum et dolor. Est nonumy elitr erat diam stet sit
                        ...
                        Nonumy</p>
                    <div class="d-flex mb-3">
                        <strong class="text-dark mr-3">Bedenler:</strong>
                        <form>
                    ...
                    <div class="d-flex mb-4">
                       ...
                       <!--
                        ...
                        <!-- sepete ekle  ssssssssssssssssssssssssssssssssssssssssssssss-->
                        <button type="submit" name="add_to_cart" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Sepete Ekle</button>
                        <?php echo "$stockerror" ?>
                        <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 150px;">
                         <input type="number" min="1" name="product_quantity" value="1" class="form-control bg-secondary border-0 text-center">
                         </div>
                        </div>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        ...
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-2">Ürün Hakkında</a>
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-3">Yorumlar</a>
                    </div>
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <h4 class="mb-3">Ürün Hakkında</h4>
                            <p>Eos no lorem eirmod diam diam, eos elitr et gubergren diam sea. Consetetur vero aliquyam invidunt duo dolores et duo sit. Vero diam ea vero et dolore rebum, dolor rebum eirmod consetetur invidunt sed sed et, lorem duo et eos elitr, sadipscing kasd ipsum rebum diam. Dolore diam stet rebum sed tempor kasd eirmod. Takimata kasd ipsum accusam sadipscing, eos dolores sit no ut diam consetetur duo justo est, sit sanctus diam tempor aliquyam eirmod nonumy rebum dolor accusam, ipsum kasd eos consetetur at sit rebum, diam kasd invidunt tempor lorem, ipsum lorem elitr sanctus eirmod takimata dolor ea invidunt.</p>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        ...
                                        <div class="media-body">
                                            <h6>Yılmaz Aladağlı<small> - <i>01 Jan 2045</i></small></h6>
                                ...
                                <div class="col-md-6">
                                    <h4 class="mb-4">Yorumla</h4>
                                    <small>E-Mail adresiniz yayınlanmayacaktır. *</small>
                                    ...
                                    <form>
                                        <div class="form-group">
                                            <label for="message">Görüşünüz *</label>
    ...
    <div class="container-fluid py-5">
        <h2 class="section-title position-relative text-uppercase mx-xl-5 mb-4"><span class="bg-secondary pr-3">BUNLARADA BAKABİLİRSİNİZ</span></h2>
        <div class="row px-xl-5">
            <div class="col">
